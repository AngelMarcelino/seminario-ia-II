...
class SLRGRADGUI extends JFrame {	
	private SLRGRADAgent myAgent;
	
	private JTextField valueToPredictField;
	
	SLRGRADGUI(SLRGRADAgent a) {
		...
		addButton.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				try {
					...
					JOptionPane.showMessageDialog(SLRGRADGUI.this, "Valores invalidos. "+e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE); 
				}
			}
		} );
		p = new JPanel();
